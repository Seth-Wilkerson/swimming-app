...
Site info title and form
 -->
	...
	<div id="container">
		...
		<form:form action="saveWorkout" modelAttribute="customer" method="POST">
		...
		<p>
			<a href="${pageContext.request.contextPath}/customer/mwork">Back to List</a>
		</p>
